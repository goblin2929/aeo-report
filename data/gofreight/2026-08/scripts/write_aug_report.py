...
<div class="page">
  ...
  <div class="two-col">
    ...
    <section>
      <h2>Title Experiment — Before &amp; After (Solution pages, ~20 Aug)</h2>
    ...
    <section>
      ...
      <p class="note" style="margin-bottom:6px;">The July NovaStacks batch targets the buyer questions AI engines are asked, to <b>bounce back AI visibility across Google AI Overview and ChatGPT</b>. Each item closes a specific WorkDuo gap, an AI-answer prompt (Google AI Overview and ChatGPT) where a competitor was cited instead of GoFreight, either by <b>refreshing an existing page</b> with focused single-question sections and an FAQ led by the exact prompt, or by <b>publishing a new focused article</b> where GoFreight had no page at all. Five examples:</p>
      <table class="t"><thead>
        <tr><th style="width:18%">Page</th><th style="width:10%">Type</th><th>Content gap (AI-answer prompt not citing GoFreight)</th><th>Before</th><th>After</th></tr>
      </thead><tbody>
        <tr>
        ...
        <tr>
          ...
          <td>No GoFreight page on multi-modal handling — AI answers (Google AI Overview and ChatGPT) surfaced competitors.</td>
